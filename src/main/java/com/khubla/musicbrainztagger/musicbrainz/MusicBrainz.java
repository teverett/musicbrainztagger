...
public class MusicBrainz {
   ...
   private static TrackInformation getTrackInformation(String recordingId, MusicBrainzResult musicBrainzResult) {
      final String artist = musicBrainzResult.getArtistcredit().get(0).getName();
      final String title = musicBrainzResult.getTitle();
      final String release = musicBrainzResult.getReleases().get(0).getTitle();
      String isrc = null;
      if ((null != musicBrainzResult.isrcs) && (musicBrainzResult.isrcs.size() > 0)) {
