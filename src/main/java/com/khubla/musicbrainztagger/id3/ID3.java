...
public class ID3 {
    ...
    */
   private static void setField(Tag tag, FieldKey fieldKey, String value) throws KeyNotFoundException, FieldDataInvalidException {
      if (null != value) {
   ...
   public static void writeTag(File file, ID3Data id3Data) throws Exception {
      try {
         ...
         if (null != audioFile) {
             ...
             * trackid
             */
            setField(tag, FieldKey.MUSICBRAINZ_TRACK_ID, id3Data.musicbrainzid);
            /*
             * isrc
             */
