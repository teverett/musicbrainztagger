...
public class MusicBrainzTagger {
	 ...
	 * process file
	 */
	private static void processMP3(File mp3File, String fpcalc,
		...
		if (null != musicbrainzId) {
			...
			if (null != trackInformation) {
				...
				final File outputFileName = namingStrategy.name(
						outputDirectory, finalTrackInformation);
				System.out.println("Recommended Filename: "
	 ...
	 */
	private static void walkDirectory(File dir, String fpcalc,
			File outputDirectory) throws Exception {
